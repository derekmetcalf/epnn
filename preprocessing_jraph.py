...
def get_init_crystal_states_and_positions(
                            path,
    ...
    if distance_encoding_type=="log1":
        ...
        distances_encoded = get_gaussian_distance_encodings(batched_distances = distances, ETA = eta, R_CUT = r_cut, dim_encoding = edge_encoding_dim)
    if ground_truth_available:
        return descriptors, distances, distances_encoded, init_charges, gt_charges, cutoff_mask, types, ohe_types, positions
    else:
        return descriptors, distances, distances_encoded, init_charges, cutoff_mask, types, ohe_types, positions
